import { User, Building2, Calendar, LogOut, Users as UsersIcon, Calculator, CalendarDays, Dumbbell, CreditCard, Wallet, Table as TableIcon } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Tablas", url: "/tables", icon: TableIcon },
    ...
    <Sidebar>
      <SidebarHeader className="border-b border-primary/20 pb-2">
        <div className="flex items-center justify-center px-2 py-4">
          <img src={logoPanthera} alt="Panthera Fitness" className="w-full h-auto object-contain" />
        </div>
      </SidebarHeader>
      <SidebarContent>
