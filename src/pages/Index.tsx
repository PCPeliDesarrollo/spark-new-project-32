    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 text-center relative z-10">
          ...
          <h1 className="font-bebas text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-wider mb-4 md:mb-6 text-primary bg-gradient-to-r from-primary via-primary-glow to-accent bg-clip-text [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] [background-clip:text] animate-fade-in leading-tight drop-shadow-[0_4px_20px_rgba(59,130,246,0.8)] [text-shadow:_0_0_40px_rgba(59,130,246,0.6)]">
