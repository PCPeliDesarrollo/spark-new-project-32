...
DROP POLICY IF EXISTS "Users can view their own renewals" ON public.subscription_renewals;
DROP POLICY IF EXISTS "Admins can view all renewals" ON public.subscription_renewals;
DROP POLICY IF EXISTS "Admins can insert renewals" ON public.subscription_renewals;
DROP POLICY IF EXISTS "Admins can update renewals" ON public.subscription_renewals;
DROP POLICY IF EXISTS "Admins can delete renewals" ON public.subscription_renewals;

-- Eliminar trigger y función si existen
DROP TRIGGER IF EXISTS notify_on_class_booking ON public.class_bookings;
DROP FUNCTION IF EXISTS notify_low_class_count();
DROP TRIGGER IF EXISTS update_subscription_renewals_updated_at ON public.subscription_renewals;
...
CREATE FUNCTION notify_low_class_count()
RETURNS trigger
LANGUAGE plpgsql
SECURITY DEFINER
